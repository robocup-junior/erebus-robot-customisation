...
export class AppComponent implements AfterViewInit {
  ...
  ngAfterViewInit() {
    ...
    this.robotModel = new THREE.Mesh( geometry, materials );
    ...
    for(let component in this.selectedComponents){
      if(this.selectedComponents[component]["name"] == "Wheel"){
        if(this.wheels[component] == undefined){
          ...
          const wheel_material_top = new THREE.MeshPhongMaterial( { map: texture} );
          const wheel_material_bot = new THREE.MeshPhongMaterial( { color: 0xffffff, opacity: 0.5,
            transparent: true,} );
          const wheel_material_side = new THREE.MeshPhongMaterial( { color: 0xffffff, opacity: 0.5,
            transparent: true,} );
            const materials = [wheel_material_side,wheel_material_top,wheel_material_bot]
          const wheel = new THREE.Mesh( wheel_geometry, materials );
  ...
  export(){
    ...
    console.log(this.selectedComponents)
    for(let component in this.selectedComponents){
      this.selectedComponents[component]["y"] += 18.5/1000;
      if(this.selectedComponents[component]["name"] == "Wheel"){
        proto_code += `
        HingeJoint {
          jointParameters HingeJointParameters {
            axis ${this.selectedComponents[component]["rz"]} ${this.selectedComponents[component]["ry"]} ${this.selectedComponents[component]["rx"]}
            anchor ${this.selectedComponents[component]["x"]} ${this.selectedComponents[component]["y"]} ${this.selectedComponents[component]["z"]}
          }
          device [
            RotationalMotor {
          ...
          endPoint Solid {
            ...
            children [
              DEF EPUCK_WHEEL Transform {
                rotation ${this.selectedComponents[component]["rx"]} ${this.selectedComponents[component]["ry"]} ${this.selectedComponents[component]["rz"]} ${this.selectedComponents[component]["a"]}
                children [
                  Shape {
